...
"""
IBD Data from Franzosa et al. Training Pipeline

This script provides a command-line interface for training various neural network models
on IBD (Inflammatory Bowel Disease) multi-omic data, specifically microbiome and metabolome
...
Usage:
    python ibd_train_all_models.py --model <model_name>

Example:
    python ibd_train_all_models.py --model d
    python ibd_train_all_models.py --model pdp
"""
...
def main():
    ...
    run_identifier = "ibd"  # Identifier for the run, can be used to save results in a specific folder
    output_path = "."
    num_processes = 10
    quiet_mode = True
    ...
    if model == 'd':
        ...
        d.grid_search(param_grid=params_for_single_network,
                    get_data_func=ibd_data_utils.get_data,
                    omic1=omic1,
                    omic2=omic2,
